...
/**
 ...
 The formula for simple interest is A = P(1 + rt), where P is the principal amount, r is the annual rate
 of interest, t is the number of years the amount is invested, and A is the amount at the end of the investment.
...
public class App 
{
    public static void main( String[] args )
    {
        ...
        double value = Math.ceil(principal*(1 + ((rate/100)*years))*100)/100;
        String output = "After " + years + " years at " + rate + "%, the investment will be worth $" + value + ".";
